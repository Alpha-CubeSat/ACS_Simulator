...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/StarshotACS.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/SSDS/Desktop/ACS-main/MATLAB~1
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
COMPILER_COMMAND_FILE     = StarshotACS_comp.rsp
CMD_FILE                  = StarshotACS.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/StarshotACS.exe
...
DEFINES_STANDARD = -DMODEL=StarshotACS -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/StarshotACS_ert_rtw/StarshotACS.cpp $(START_DIR)/StarshotACS_ert_rtw/StarshotACS_data.cpp

MAIN_SRC = $(START_DIR)/StarshotACS_ert_rtw/ert_main.cpp
...
OBJS = StarshotACS.obj StarshotACS_data.obj
...
%.obj : $(START_DIR)/StarshotACS_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/StarshotACS_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

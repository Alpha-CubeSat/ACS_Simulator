...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Plantv50.exe
...
COMPILER_COMMAND_FILE     = Plantv50_comp.rsp
CMD_FILE                  = Plantv50.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Plantv50.exe
...
DEFINES_STANDARD = -DMODEL=Plantv50 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/Plantv50_ert_rtw/Plantv50.cpp $(START_DIR)/Plantv50_ert_rtw/Plantv50_data.cpp

MAIN_SRC = $(START_DIR)/Plantv50_ert_rtw/ert_main.cpp
...
OBJS = Plantv50.obj Plantv50_data.obj
...
%.obj : $(START_DIR)/Plantv50_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Plantv50_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

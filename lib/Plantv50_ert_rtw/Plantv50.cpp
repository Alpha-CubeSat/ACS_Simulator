...
void Plantv50ModelClass::step(float step_size)
{
  ...
  rtDW.DiscreteTimeIntegrator1_DSTA_ls += rtb_TrigonometricFunction * (1.0 /
    rtb_Sum6 * rtDW.DiscreteTimeIntegrator5_DSTATE) * step_size;
  ...
  rtDW.DiscreteTimeIntegrator2_DSTAT_e += rtb_TrigonometricFunction * (1.0 /
    rtb_Sum6 * rtDW.DiscreteTimeIntegrator4_DSTATE) * step_size;
  ...
  rtDW.DiscreteTimeIntegrator3_DSTATE += rtb_TrigonometricFunction * (1.0 /
    rtb_Sum6 * rtDW.DiscreteTimeIntegrator6_DSTATE) * step_size;
  ...
  rtb_TrigonometricFunction = 1.5707963267948966 - rt_atan2d_snf
    (rtb_DiscreteTimeIntegrator6, std::sqrt(rtb_DotProduct2_0 *
      rtb_DotProduct2_0 + rtb_DiscreteTimeIntegrator5 *
  ...
  rtb_DiscreteTimeIntegrator1 = 2.0 * rtb_Sum6 * std::cos
  ...
  rtDW.DiscreteTimeIntegrator1_DSTATE[0] += ((rtb_Product[3] *
    ...
    rtDW.DiscreteTimeIntegrator2_DSTATE) / 2.0 * step_size;
...
void Plantv50ModelClass::initialize(float DiscreteTimeIntegrator_DSTATE, float DiscreteTimeIntegrator1_DSTAT_l, float DiscreteTimeIntegrator2_DSTATE)
{
  ...
  rtDW.DiscreteTimeIntegrator1_DSTATE[0] = 0.49999999999999994;
  rtDW.DiscreteTimeIntegrator1_DSTATE[1] = 0.5;
  rtDW.DiscreteTimeIntegrator1_DSTATE[2] = -0.18301270189221924;

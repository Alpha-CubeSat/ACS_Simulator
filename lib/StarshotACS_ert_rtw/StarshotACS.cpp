...
void StarshotACS::step()
{
  ...
  if ((&rtM)->Timing.TaskCounters.TID[1] == 0)
  {
    ...
    rtb_Saturation6 = (rtU.Bfield_body[0] * rtU.Bfield_body[0] +
                       rtU.Bfield_body[1] * rtU.Bfield_body[1]) +
    ...
    rtb_Product1[0] = rtU.w[0] * 5.0;
    rtb_Product1[1] = rtU.w[1] * 5.0;
    rtb_Product1[2] = rtU.w[2] * 5.0;
    ...
    rtb_TSamp_o = rtb_TrigonometricFunction5 * 5.0;

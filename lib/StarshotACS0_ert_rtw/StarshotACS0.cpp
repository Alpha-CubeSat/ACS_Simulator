...
void StarshotACS0ModelClass::step()
{
  ...
  rtb_Gain8_idx_2 = (rtb_Gain_2 * rtb_Gain8_idx_2 - rtb_Gain8_idx_0 *
                     rtb_TrigonometricFunction5) * 0.025063770565652812;
  ...
  rtb_Gain8_idx_0 = (rtb_Gain8_idx_0 * rtb_Gain_3 - rtb_TSamp_o *
                     rtb_Gain8_idx_1) * 0.025063770565652812;
  ...
  rtb_TSamp_o = rtb_TrigonometricFunction5 * 10.0;
  ...
  rtb_Gain[2] = ((rtb_TSamp_o - rtDW.UD_DSTATE_k) * 1.5890498768155689E-6 +
                 5.02469927340896E-10 * rtb_TrigonometricFunction5) *
    static_cast<real_T>(tmp * i) / rtb_Product7 * 0.025063770565652812;
  ...
  for (i = 0; i < 3; i++) {
    ...
    rtDW.DiscreteTimeIntegrator_DSTATE[i] += ((0.0 - (rtb_Gain_0 -
      ...
      -rtb_Product1 * 0.004 * rtb_VectorConcatenate_0[i + 6])) * 0.1;
  ...
  if (rtb_Gain[2] > 0.00050127541131305623) {
    // Outport: '<Root>/point'
    rtY.point[2] = 0.00050127541131305623;
  } else if (rtb_Gain[2] < -0.00050127541131305623) {
    // Outport: '<Root>/point'
    rtY.point[2] = -0.00050127541131305623;
  } else {
    // Outport: '<Root>/point'
